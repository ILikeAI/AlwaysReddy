...
Ollama_API = False # Flag to control the visibility of the tabview
if Ollama_API:
...
LM_Studio_API = True # Flag to control the visibility of the tabview
if LM_Studio_API:
