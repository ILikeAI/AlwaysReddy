...
INPUT_HANDLER = "keyboard" # "autohotkey" or "keyboard" #  On windows there are 2 options for input handler libraries, the the default is the 'keyboard' library, however some users may prefer to use "autohotkey"
